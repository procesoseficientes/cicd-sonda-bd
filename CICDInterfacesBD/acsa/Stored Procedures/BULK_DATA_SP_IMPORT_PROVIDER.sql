...
-- Ejemplo de Ejecucion:
				-- 
				EXEC [acsa].[BULK_DATA_SP_IMPORT_PROVIDER]
*/
-- =============================================
CREATE PROCEDURE [acsa].[BULK_DATA_SP_IMPORT_PROVIDER]
AS
BEGIN
	SET NOCOUNT ON;
	--
	MERGE acsa.SWIFT_ERP_PROVIDERS TRG
	USING (SELECT * FROM acsa.ERP_VIEW_PROVIDERS) AS SRC

...
-- Ejemplo de Ejecucion:
				-- 
				EXEC [acsa].[BULK_DATA_SP_IMPORT_SELLER]
*/
-- =============================================
CREATE PROCEDURE [acsa].[BULK_DATA_SP_IMPORT_SELLER]
AS
BEGIN
	SET NOCOUNT ON;
	--
	MERGE [SWIFT_EXPRESS_R].[acsa].[SWIFT_SELLER] [TRG]
	USING (SELECT * FROM SWIFT_INTERFACES_ONLINE_R.[acsa].ERP_VIEW_SELLER) AS [SRC]

...
-- Ejemplo de Ejecucion:
				-- TIME 0:40:45:617
				EXEC [acsa].[BULK_DATA_SP_IMPORT_PRICE_LIST_BY_CUSTOMER]
*/
-- =============================================
CREATE PROCEDURE [acsa].[BULK_DATA_SP_IMPORT_PRICE_LIST_BY_CUSTOMER]
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  MERGE [SWIFT_EXPRESS_R].[acsa].[SWIFT_PRICE_LIST_BY_CUSTOMER] [TGR]
  USING (SELECT
      *
    FROM [SWIFT_INTERFACES_ONLINE_R].[acsa].[ERP_PRICE_LIST_BY_CUSTOMER]) [SRC]

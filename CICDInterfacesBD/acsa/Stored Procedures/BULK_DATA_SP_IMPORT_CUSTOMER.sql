...
-- Ejemplo de Ejecucion:
				-- 
				EXEC [acsa].[BULK_DATA_SP_IMPORT_CUSTOMER]
*/
-- =============================================
CREATE PROCEDURE [acsa].[BULK_DATA_SP_IMPORT_CUSTOMER]
AS
BEGIN
  SET NOCOUNT ON;
  --
	MERGE [acsa].[SWIFT_ERP_CUSTOMERS] [TRG]
	USING
		(SELECT
				*
			FROM
				[SWIFT_INTERFACES_ONLINE_R].[acsa].[ERP_VIEW_COSTUMER])
		AS [SRC]

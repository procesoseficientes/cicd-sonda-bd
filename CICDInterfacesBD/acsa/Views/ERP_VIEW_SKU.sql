...
-- Ejemplo de Ejecucion:
        SELECT * FROM [acsa].[ERP_VIEW_SKU]
*/
-- =============================================

CREATE VIEW [acsa].[ERP_VIEW_SKU]
AS
	SELECT
		[SKU]
		,[CODE_SKU]
		...
		, (CASE WHEN [HANDLE_SERIAL_NUMBER]='N' THEN 0 ELSE 1 END) AS [HANDLE_SERIAL_NUMBER] -- SE AGREGO EL CASE POR CUESTIONES DE BINDING
		,[HANDLE_BATCH]
		,[FROM_ERP]
		,[PRICE]
		,[LIST_NUM]

CREATE TABLE [acsa].[SWIFT_TRADE_AGREEMENT] (
    ...
    [STATUS]                      INT           CONSTRAINT [DF__SWIFT_TRA__STATU__39836D4D] DEFAULT ((0)) NOT NULL,
    [LAST_UPDATE]                 DATETIME      NOT NULL,
    [LAST_UPDATE_BY]              VARCHAR (50)  NOT NULL,
    [LINKED_TO]                   VARCHAR (250) NULL,
    CONSTRAINT [PK__SWIFT_TR__5D4BB0CF4B4A4625] PRIMARY KEY CLUSTERED ([TRADE_AGREEMENT_ID] ASC),
    CONSTRAINT [UQ__SWIFT_TR__8CC5FA131BF3F2B0] UNIQUE NONCLUSTERED ([CODE_TRADE_AGREEMENT] ASC)
);

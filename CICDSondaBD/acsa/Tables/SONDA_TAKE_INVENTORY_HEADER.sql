CREATE TABLE [acsa].[SONDA_TAKE_INVENTORY_HEADER] (
    ...
    [IS_VOID]                INT           NULL,
    [TASK_ID]                INT           NULL,
    [SERVER_POSTED_DATETIME] DATETIME      CONSTRAINT [DF__SONDA_TAK__SERVE__7FF5EA36] DEFAULT (getdate()) NOT NULL,
    [DEVICE_NETWORK_TYPE]    VARCHAR (15)  NULL,
    [IS_POSTED_OFFLINE]      INT           CONSTRAINT [DF__SONDA_TAK__IS_PO__00EA0E6F] DEFAULT ((0)) NOT NULL,

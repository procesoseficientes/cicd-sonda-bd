CREATE TABLE [acsa].[SWIFT_SELLER] (
    ...
    CONSTRAINT [FK_SWIFT_SELLER_SALES_OFFICE_ID] FOREIGN KEY ([SALES_OFFICE_ID]) REFERENCES [acsa].[SWIFT_SALES_OFFICE] ([SALES_OFFICE_ID])
);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_SELLER_SELLER_CODE]
    ON [acsa].[SWIFT_SELLER]([SELLER_CODE] ASC)
    INCLUDE([SELLER_NAME]);

CREATE TABLE [acsa].[SWIFT_BATCH] (
    ...
    CONSTRAINT [FK_SWIFT_BATCH_TASK_ID] FOREIGN KEY ([TASK_ID]) REFERENCES [acsa].[SWIFT_TASKS] ([TASK_ID])
);


GO
CREATE NONCLUSTERED INDEX [IDX_BATCH_TASK_ID]
    ON [acsa].[SWIFT_BATCH]([TASK_ID] ASC);

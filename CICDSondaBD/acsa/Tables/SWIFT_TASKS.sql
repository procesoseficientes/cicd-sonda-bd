CREATE TABLE [acsa].[SWIFT_TASKS] (
    ...
    [IS_POSTED_OFFLINE]      INT           CONSTRAINT [DF__SWIFT_TAS__IS_PO__2858E14B] DEFAULT ((0)) NOT NULL,
...
CREATE NONCLUSTERED INDEX [IDX_TASKS]
    ...
    INCLUDE([TASK_ID], [TASK_DATE], [ASSIGNED_BY], [ACCEPTED_STAMP], [COMPLETED_STAMP], [EXPECTED_GPS], [POSTED_GPS], [TASK_COMMENTS], [TASK_SEQ], [COSTUMER_CODE], [COSTUMER_NAME], [TASK_ADDRESS], [CREATED_STAMP]);

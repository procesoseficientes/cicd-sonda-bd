CREATE TABLE [acsa].[SWIFT_CUSTOMERS_NEW] (
    ...
    [DEPARTAMENT]             VARCHAR (250) CONSTRAINT [DF__SWIFT_CUS__DEPAR__650CE9D0] DEFAULT ('NO ESPECIFICADO') NULL,
    [MUNICIPALITY]            VARCHAR (250) CONSTRAINT [DF__SWIFT_CUS__MUNIC__66010E09] DEFAULT ('NO ESPECIFICADO') NULL,
    [COLONY]                  VARCHAR (250) CONSTRAINT [DF__SWIFT_CUS__COLON__66F53242] DEFAULT ('NO ESPECIFICADO') NULL,
    ...
    [OWNER_ID]                INT           NULL,
    [IS_FROM]                 VARCHAR (50)  CONSTRAINT [DF__SWIFT_CUS__IS_FR__67E9567B] DEFAULT ('SONDA_CORE') NULL,
    [JSON]                    VARCHAR (MAX) CONSTRAINT [DF__SWIFT_CUST__JSON__68DD7AB4] DEFAULT (NULL) NULL,
    [SERVER_POSTED_DATETIME]  DATETIME      CONSTRAINT [DF__SWIFT_CUS__SERVE__69D19EED] DEFAULT (getdate()) NOT NULL,
    [DEVICE_NETWORK_TYPE]     VARCHAR (15)  NULL,
    [IS_POSTED_OFFLINE]       INT           CONSTRAINT [DF__SWIFT_CUS__IS_PO__6AC5C326] DEFAULT ((0)) NOT NULL,
    CONSTRAINT [PK__SWIFT_CU__DFC10729101E7B5D] PRIMARY KEY CLUSTERED ([CUSTOMER] ASC),
    CONSTRAINT [FK__SWIFT_CUS__OWNER__4F089A18] FOREIGN KEY ([OWNER_ID]) REFERENCES [acsa].[SWIFT_COMPANY] ([COMPANY_ID])
);

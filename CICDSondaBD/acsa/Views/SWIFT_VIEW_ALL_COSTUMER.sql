...
SELECT
	...
	,[CODE_CUSTOMER] COLLATE DATABASE_DEFAULT [CODE_CUSTOMER]
	,[NAME_CUSTOMER]
	,[PHONE_CUSTOMER]
	,[ADRESS_CUSTOMER]
...
SELECT
	...
	,[C].[FROM_ERP] [FROM_ERP]
	,[C].[TAX_ID_NUMBER] COLLATE DATABASE_DEFAULT
	,[C].[GPS]COLLATE DATABASE_DEFAULT
	,[C].[LATITUDE]COLLATE DATABASE_DEFAULT
	,[C].[LONGITUDE]COLLATE DATABASE_DEFAULT
	,[C].[FREQUENCY]COLLATE DATABASE_DEFAULT
	,[C].[SUNDAY] COLLATE DATABASE_DEFAULT
	,[C].[MONDAY] COLLATE DATABASE_DEFAULT
	,[C].[TUESDAY] COLLATE DATABASE_DEFAULT
	,[C].[WEDNESDAY] COLLATE DATABASE_DEFAULT
	,[C].[THURSDAY] COLLATE DATABASE_DEFAULT
	,[C].[FRIDAY] COLLATE DATABASE_DEFAULT
	,[C].[SATURDAY] COLLATE DATABASE_DEFAULT
	,[C].[SCOUTING_ROUTE] COLLATE DATABASE_DEFAULT
	...
	,[C].[RGA_CODE] COLLATE DATABASE_DEFAULT
	,[C].[ORGANIZACION_VENTAS]COLLATE DATABASE_DEFAULT
	,[C].[PAYMENT_CONDITIONS] COLLATE DATABASE_DEFAULT
	,[C].[OWNER] COLLATE DATABASE_DEFAULT
	,[C].[OWNER_ID] COLLATE DATABASE_DEFAULT
	,ISNULL([C].[BALANCE],CAST(0.00 AS NUMERIC(18,6)))
	,[C].[INVOICE_NAME] COLLATE DATABASE_DEFAULT
	,[C].CODE_CUSTOMER_ALTERNATE COLLATE DATABASE_DEFAULT
	,NULL AS [GROUP_NUM]
	,0 AS [SPECIAL_MARKER]
FROM
	[$(CICDInterfacesBD)].[acsa].[ERP_VIEW_COSTUMER] [C], 

...
AS
SELECT  DISTINCT   
	(SELECT TOP 1 Z.[NAME_PROVIDER] FROM [acsa].[SWIFT_VIEW_ALL_PROVIDERS] AS Z WHERE Z.CODE_PROVIDER COLLATE SQL_Latin1_General_CP1_CI_AS= 
...
WHERE A.ON_HAND > 0 AND (SELECT TOP 1 Z.[NAME_PROVIDER] FROM [acsa].[SWIFT_VIEW_ALL_PROVIDERS] AS Z WHERE Z.CODE_PROVIDER COLLATE SQL_Latin1_General_CP1_CI_AS = 
	(SELECT TOP 1 Y.[CODE_PROVIDER] FROM [acsa].[SWIFT_RECEPTION_HEADER] AS Y WHERE Y.[RECEPTION_HEADER] =
	(SELECT TOP 1 W.[HEADER_REFERENCE] FROM [acsa].[SWIFT_TXNS] AS W WHERE W.[TXN_ID] = 

...
Ejemplo de Ejecucion:
	...
	EXEC [acsa].[SWIFT_SP_VALIDATE_RECEPTION_BY_PICKING]
	@PICKING_HEADER = 1020
	------------------------------------------
	SELECT * FROM [acsa].[SWIFT_RECEPTION_HEADER] AS RH
	WHERE RH.SOURCE_DOC = 1020
	 				
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_VALIDATE_RECEPTION_BY_PICKING]
(
	@PICKING_HEADER INT
)
AS
BEGIN
	...
	FROM [acsa].[SWIFT_RECEPTION_HEADER] AS RH

...
-- Ejemplo de Ejecucion:				
				--
EXECUTE  [acsa].[SWIFT_SP_VALIDATE_SKU_UBICATION] 
    @LOCATION = 2
   ,@CODE_SKU = '20GE'
   ,@PALLET_ID = 1279
				--				
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_VALIDATE_SKU_UBICATION]
...
BEGIN 
  ...
  INNER JOIN [acsa].[SWIFT_LOCATIONS] AS LO ON (LO.[CODE_LOCATION] = PA.[LOCATION])

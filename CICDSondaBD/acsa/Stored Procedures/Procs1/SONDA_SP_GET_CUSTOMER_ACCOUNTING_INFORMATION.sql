...
Ejemplo de Ejecucion:
	...
	EXEC [acsa].[SONDA_SP_GET_CUSTOMER_ACCOUNTING_INFORMATION] @CODE_ROUTE = 'rp-27', @CODE_CUSTOMER = '860802'
...
AS
  ...
  --
		...
		ON	[C].[CODE_CUSTOMER] = [AI].[CODE_CUSTOMER] COLLATE DATABASE_DEFAULT
		WHERE
			[AI].[ID] > 0;

...
-- Ejemplo de Ejecucion:
		exec [acsa].[SWIFT_SP_GET_SCOUTING_DETAIL]
			@CODE_CUSTOMER = 3145
-- =============================================*/
CREATE PROCEDURE [acsa].[SWIFT_SP_GET_SCOUTING_DETAIL]
(
	@CODE_CUSTOMER INT
) AS
BEGIN
	...
	SELECT [CND].[CUSTOMER]
		...
		,[VAC].[COMMENTS]
		,[VAC].[LAST_UPDATE]
	FROM [acsa].[SWIFT_CUSTOMER_NEW_DETAIL] AS CND
	INNER JOIN [acsa].[SWIFT_CUSTOMERS_NEW] AS VAC ON(

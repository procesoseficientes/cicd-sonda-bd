...
-- EJEMPLO DE EJECUCION: 
		EXEC [acsa].[SWIFT_SP_GET_AVAILABLE_TAGS_BY_SCOUTING]
...
CREATE PROCEDURE [acsa].[SWIFT_SP_GET_AVAILABLE_TAGS_BY_SCOUTING]
(
...
BEGIN
	...
	BEGIN TRY
		...
		WHERE [T].[TAG_COLOR] 
			...
			FROM [acsa].[SWIFT_VIEW_ALL_TAG_X_CUSTOMER_NEW] AS TXC 

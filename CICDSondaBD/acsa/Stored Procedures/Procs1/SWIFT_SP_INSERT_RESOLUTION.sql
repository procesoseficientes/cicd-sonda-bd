...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [SONDA_POS_RES_SAT] WHERE [AUTH_ID] = @AUTH_ID)
    BEGIN
    ...
    BEGIN
        ...
        VALUES
        (   @AUTH_ID, @ASSIGNED_DATETIME, @POST_DATETIME, @ASSIGNED_BY, @DOC_FROM, @DOC_TO, @SERIE, 'FACTURA',
            @ASSIGNED_TO, @DOC_FROM, @LIMIT_DATETIME, 1, @BRANCH_NAME, @BRANCH_ADDRES, @BRANCH_ADDRESS2,

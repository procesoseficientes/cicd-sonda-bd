...
-- Ejemplo de Ejecucion:
				--
				EXEC [acsa].[SWIFT_SP_GET_PROVIDER_INVENTORY_WITHOUT_SERIE]
				--
				EXEC [acsa].[SWIFT_SP_GET_PROVIDER_INVENTORY_WITHOUT_SERIE] @CODE_PROVIDER = 'P0001'
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_GET_PROVIDER_INVENTORY_WITHOUT_SERIE]
...
BEGIN
	SELECT
		...
		,P.[PALLET_ID]
		,P.[ON_HAND]
	FROM [acsa].[SWIFT_VIEW_PROVIDER_INVENTORY_WITHOUT_SERIE] P

...
-- Ejemplo de Ejecucion:
				DECLARE 
					...
					,@QTY INT = 1
				--
				SELECT * FROM [acsa].[SONDA_IS_COMITED_BY_WAREHOUSE] WHERE CODE_WAREHOUSE = @CODE_WAREHOUSE AND CODE_SKU = @CODE_SKU
				--
				EXEC [acsa].[SONDA_SP_VOID_COMMITED_INVENTORY]
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SONDA_SP_VOID_COMMITED_INVENTORY]
(	

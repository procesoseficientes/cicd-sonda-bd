...
SELECT DISTINCT 
	...
	coalesce(C.NAME_PROVIDER COLLATE SQL_Latin1_General_CP1_CI_AS,e.NAME_CUSTOMER) AS 'PROVEEDOR',
...
left JOIN acsa.SWIFT_VIEW_ALL_PROVIDERS C on(A.CODE_PROVIDER = C.CODE_PROVIDER COLLATE SQL_Latin1_General_CP1_CI_AS)

...
BEGIN
	...
	INNER JOIN [acsa].[SWIFT_VIEW_USERS] AS U 	ON (T.[ASSIGEND_TO] = U.[LOGIN] COLLATE DATABASE_DEFAULT)
	...
	INNER JOIN acsa.SWIFT_VIEW_ALL_SKU S on (S.CODE_SKU =  I.SKU COLLATE DATABASE_DEFAULT)

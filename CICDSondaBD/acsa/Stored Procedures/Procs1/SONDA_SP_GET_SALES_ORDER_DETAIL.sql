...
-- Ejemplo de Ejecucion:
				exec [acsa].[SONDA_SP_GET_SALES_ORDER_DETAIL]  @SALES_ORDER_ID = 4021
*/
-- =============================================
CREATE PROCEDURE [acsa].[SONDA_SP_GET_SALES_ORDER_DETAIL]
	@SALES_ORDER_ID INT
...
BEGIN
  ...
  UPDATE [acsa].[SONDA_SALES_ORDER_DETAIL]

...
-- Ejemplo de Ejecucion:				
				--EXECUTE [acsa].[SWIFT_SP_GET_TASK_REVIEW_BY_ROUTE]
							   @CODE_ROUTE= '001' --codigo ruta
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_GET_TASK_REVIEW_BY_ROUTE]
...
BEGIN
	...
	FROM [acsa].[SWIFT_TASKS] AS TASK 
	INNER JOIN [acsa].[USERS] AS USERS ON (USERS.[LOGIN] = TASK.[ASSIGEND_TO])
